...
def main():
    ...
    backend = subprocess.Popen(
        ["D:/Anaconda/python.exe", "-m", "uvicorn", "app.main:app",
         "--host", "0.0.0.0", "--port", "8000"],
        cwd="D:/XM/smart-doc-qa",
    ...
    if status == 200:
        ...
        if kb_id:
            ...
            results.append(("T3", "问答功能", "✅ 通过" if status == 200 else "❌ 失败", body[:200]))
    ...
    # 保存报告
    with open("D:/XM/smart-doc-qa/test_report_auto.md", "w", encoding="utf-8") as f:
        f.write("# SmartDocQA 自动化测试报告\n\n")
    ...
    log("报告已保存: D:/XM/smart-doc-qa/test_report_auto.md")
